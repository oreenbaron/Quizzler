...
//  Quizzler
//
//  Created by Orin Baron on 5/14/18.
...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "Jupiter is composed mostly of iron.", correctAnswer: false))
        
        list.append(Question(text: "The planet Venus has no moons.", correctAnswer: true))
        ...
        list.append(Question(text: "The earth is the fourth planet from the sun.", correctAnswer: false))
    }
